...
class PrecisionTheme {
  // Core Palette defined for Immediate Response HVAC
  static const Color background = Color(0xFF000000); 
  static const Color surfaceVeryDark = Color(0xFF0A0A0A);
  static const Color surfaceContainer = Color(0xFF131313); 
  
  static const Color primaryCyan = Color(0xFF00E5FF);
  static const Color pureWhite = Color(0xFFFFFFFF);
  
  // 15% Ghost border rule
  ...
  static ThemeData get themeData {
    ...
    final TextTheme imrTextTheme = GoogleFonts.spaceGroteskTextTheme(baseTextTheme).copyWith(
    ...
    return ThemeData(
      ...
      colorScheme: const ColorScheme.dark(
        ...
        onSurface: pureWhite,
        shadow: Colors.transparent, // 'No-Shadow' Rule
      ),
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: ghostBorder, width: 1), // 15% Ghost Border
        ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: const BorderSide(color: primaryCyan, width: 2), // Aggressive active state
          borderRadius: BorderRadius.circular(6),
        ),
      ),
